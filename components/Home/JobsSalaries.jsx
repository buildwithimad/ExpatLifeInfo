...
export default function JobsSalaries({ lang, jobPosts }) {
  const isArabic = lang === "ar";

  // UI Translations
  const t = {
    sectionEyebrow: isArabic ? "الذكاء المهني" : "Career Intelligence",
    sectionTitle: isArabic ? "الوظائف والرواتب" : "Jobs & Salaries",
    viewAll: isArabic ? "جميع أخبار المهن" : "All Career News",
    defaultCategory: isArabic ? "وظائف" : "Jobs",
